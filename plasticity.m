classdef plasticity < handle
    ...
    methods
        ...
        function write(obj)
            ...
            theme(gcf,"light");
            subplot(1,2,1);
            obj.unk.u.plot(prc="norm",trisurf=0);
            colorbar;
            subplot(1,2,2);
            obj.unk.z.plot(prc="norm",trisurf=0);
            colorbar;
            sgtitle(sprintf("t=%.3f",obj.t));
            drawnow;
        end
        ...
        function [res,stiff]=assemble(obj)
            ...
            int=squeeze(sum(reshape(u.val{1,1},d,1,[]).*reshape(sR{2,1},d,nR,[]),1));
            res2=asmbvec(int,2,1,2,R);
            int=squeeze(sum(reshape(-g,d,1,[]).*reshape(sR{1,1},d,nR,[]),1));
            res2=res2+asmbvec(int,1,1,1,R);
            ...
            obj.mlt.rescomp={res1,res2,res3,res4,res5,res6};
            ...
            obj.mlt.stiffblk={stiff11,stiff12,stiff13,stiff14,stiff15,[];
                obj.dt*stiff12',[],[],[],[],[];
                obj.dt*stiff13',[],[],[],[],[];
        ...
        function solve(obj)
            ...
            while obj.t<obj.T
                ...
                while nor>obj.setting.newton.tol
                    ...
                    obj.unk.dotu.dof=obj.unk.dotu.dof+ddotu;
                    obj.unk.u.dof=u0+obj.dt*obj.unk.dotu.dof;
                    obj.unk.r.dof=obj.unk.r.dof+dr;
                    obj.unk.m.dof=obj.unk.m.dof+dm;
                    obj.unk.dotz.dof=obj.unk.dotz.dof+ddotz;
                    obj.unk.z.dof=z0+obj.dt*obj.unk.dotz.dof;
                    obj.unk.la.dof=obj.unk.la.dof+dla;
                    obj.unk.p.dof=obj.unk.p.dof+dp;
